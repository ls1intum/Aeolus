...
/**
 * The actions that are executed during a CI job in a target system. When a job is executed, the actions are executed in the order they are defined in the windfile.
 */
 ...
 */
export interface WindfileMetadata {
  /**
   * The name of the windfile.
   */
  name: string;
  /**
   * The id of the resulting job in the CI system.
   */
  id?: string;
  /**
  ...
  targets?: Targets[];
  /**
   * The git credentials that are used to clone the repositories
   */
...
export interface GitCredentials {
  /**
   * The username of the git credentials.
   */
  username: string;
  /**
   * The password of the git credentials.
   */
  password: string;
  [k: string]: unknown;
}
/**
 * The docker configuration that is used to execute the actions
 */
...
export interface Repository {
  ...
  branch: string;
  /**
   * The path where the content of the repository should be checked out
   */
  path: string;
  [k: string]: unknown;
}
